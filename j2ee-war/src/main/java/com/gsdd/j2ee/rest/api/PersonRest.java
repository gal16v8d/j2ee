...
import com.gsdd.j2ee.rest.api.request.PersonRequest;
...
public interface PersonRest {
    ...
    @ApiOperation(value = "Finds Person using a proxy client from jeeservice", response = com.gsdd.jeeservice.model.Person.class)
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Person from proxy", response = com.gsdd.jeeservice.model.Person.class),
